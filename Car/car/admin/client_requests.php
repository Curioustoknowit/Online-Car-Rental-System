					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Approve</a><a href="javascript:sureToReject(<?php echo $row['client_id'];?>)" class="ico edit">Reject</a></td>
							</tr>
							<?php
								}
							?>
...
<div id="footer">
	<div class="shell">
		<span class="left">&copy; <?php echo date("Y");?> - ABC Car Rentals</span>
		<span class="right">
			Design by Sujith Kumar</a>
		</span>
	</div>
</div>
<!-- End Footer -->
